...
azW = nan(1,trltime); azW_pred = nan(1,trltime);
elW = nan(1,trltime); elW_pred = nan(1,trltime);
spd = nan(1,trltime);
...
wandPred = 1.2; % forecsat the wand further than it actually would move to simulate prediction
...
azW(1) = 0; elW(1) = -3;
azW_pred(1) = azW(1); elW_pred(1) = elW(1);
rho_pre = 0;

%%
%% How do i incorporate motor prediction?
%%
...
for t = 2:trltime-targPred
    ...
    plot(azT(t), elT(t), 'o','MarkerSize', 10, 'MarkerFaceColor', 'b', 'MarkerEdgeColor', 'k')
    plot(azW(t), elW(t), 'o','MarkerSize', 10, 'MarkerFaceColor', 'r', 'MarkerEdgeColor', 'k')
